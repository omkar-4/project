    ...
    */
    ...
    setPosition(){
        this.imageStore.forEach((img)=>{
            ...
            // iss math code ke wajeh se meri imgs sahi position pr aayegi
        })
    }
    ...
    addImages(){
        ...
        const uniforms = {
            uTime : { value : 0},
            uTimeline : { value : 0.2}, // iska role hai  kisi 0 point se doosre point tk animation perform karna
            uStartIndex:{value: 0},
            uEndIndex:{value: 1},
    ...
    render(){
        ...
        // this is no cube anymore so no rotation
        this.renderer.render(this.scene, this.camera);
